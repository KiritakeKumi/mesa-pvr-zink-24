    ...
    fn parse_intrinsic(
        ...
        match intrin.intrinsic {
            ...
            nir_intrinsic_convert_alu_types => {
                // This is currently only generated by nak_nir_lower_tex,
                // so we implement a very limited subset of the intrinsic
                assert_eq!(intrin.src_type(), nir_type_float32);
                assert_eq!(intrin.dest_type(), nir_type_uint32);
                assert_eq!(intrin.rounding_mode(), nir_rounding_mode_rtne);
                assert_eq!(intrin.saturate(), true);
                ...
                b.push_op(OpF2I {
                    ...
                    rnd_mode: FRndMode::NearestEven,
                    ftz: self.float_ctl[FloatType::F32].ftz,
                });
