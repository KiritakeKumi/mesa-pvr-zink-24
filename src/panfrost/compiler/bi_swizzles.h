 ...
 *
 * These may differ between bifrost and valhall for the same opcode.
 *
 * Generated in bi_swizzles.c.py */
extern uint32_t bi_op_swizzles[BI_NUM_OPCODES][BI_MAX_SRCS];
/* Generated in valhall_swizzles.c.py */
/* extern uint32_t va_op_swizzles[BI_NUM_OPCODES][BI_MAX_SRCS]; */
